# Generated by Django 5.1.6 on 2025-02-17 02:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('draft', 'Draft'), ('posted', 'Posted')], default='draft', max_length=100)),
                ...
                ('categories', models.ManyToManyField(blank=True, related_name='categories', to='blog.blogcategory')),
            ],
            options={
                'ordering': ['-posted_at'],
            },
